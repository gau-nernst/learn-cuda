...
matmul_v2:
	...
	v_or_b32_e32 v131, v1, v0
	v_or_b32_e32 v132, v4, v0
...
.LBB0_1:
	...
	s_mov_b32 m0, s18
	v_or_b32_e32 v140, 0x500000, v135
	buffer_load_dwordx4 v139, s[4:7], 0 offen lds
	s_mov_b32 m0, s19
	v_or_b32_e32 v141, 0x600000, v135
	buffer_load_dwordx4 v140, s[4:7], 0 offen lds
	s_mov_b32 m0, s20
	v_or_b32_e32 v142, 0x700000, v135
	...
	; ##### inner k tile 0 #####
	; load B0-B3 and A0-A1
	ds_read_b128 v[152:155], v132 offset:4096  ; load B2
	ds_read_b128 v[156:159], v132 offset:6144  ; load B3
	ds_read_b128 v[136:139], v132              ; load B0
	ds_read_b128 v[140:143], v132 offset:2048  ; load B1
	ds_read_b128 v[144:147], v131              ; load A0
	ds_read_b128 v[148:151], v131 offset:2048  ; load A1

	; wait B0-B3 + A0, compute A0 x [B0, B1, B2, B3]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_16x16x32_bf16 v[112:115], v[136:139], v[144:147], v[112:115]
	v_mfma_f32_16x16x32_bf16 v[124:127], v[140:143], v[144:147], v[124:127]
	v_mfma_f32_16x16x32_bf16 v[120:123], v[152:155], v[144:147], v[120:123]
	v_mfma_f32_16x16x32_bf16 v[116:119], v[156:159], v[144:147], v[116:119]

	; wait A1, compute A1 x [B0, B1, B2, B3]
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_16x16x32_bf16 v[108:111], v[136:139], v[148:151], v[108:111]
	v_mfma_f32_16x16x32_bf16 v[104:107], v[140:143], v[148:151], v[104:107]
	v_mfma_f32_16x16x32_bf16 v[100:103], v[152:155], v[148:151], v[100:103]
	v_mfma_f32_16x16x32_bf16 v[96:99], v[156:159], v[148:151], v[96:99]

	; load A2-A3, reuse A0-A1 registers
	ds_read_b128 v[144:147], v131 offset:4096
	ds_read_b128 v[148:151], v131 offset:6144

	; wait A2-A3, compute [A2, A3] x [B0, B1, B2, B3]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_16x16x32_bf16 v[92:95], v[136:139], v[144:147], v[92:95]
	v_mfma_f32_16x16x32_bf16 v[88:91], v[140:143], v[144:147], v[88:91]
	v_mfma_f32_16x16x32_bf16 v[84:87], v[152:155], v[144:147], v[84:87]
	v_mfma_f32_16x16x32_bf16 v[80:83], v[156:159], v[144:147], v[80:83]
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_16x16x32_bf16 v[76:79], v[136:139], v[148:151], v[76:79]
	v_mfma_f32_16x16x32_bf16 v[72:75], v[140:143], v[148:151], v[72:75]
	v_mfma_f32_16x16x32_bf16 v[68:71], v[152:155], v[148:151], v[68:71]
	v_mfma_f32_16x16x32_bf16 v[64:67], v[156:159], v[148:151], v[64:67]

	; load A4-A5, reuse A2-A3 registers
	ds_read_b128 v[144:147], v131 offset:8192
	ds_read_b128 v[148:151], v131 offset:10240

	; wait A4-A5, compute [A4, A5] x [B0, B1, B2, B3]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_16x16x32_bf16 v[60:63], v[136:139], v[144:147], v[60:63]
	v_mfma_f32_16x16x32_bf16 v[56:59], v[140:143], v[144:147], v[56:59]
	v_mfma_f32_16x16x32_bf16 v[52:55], v[152:155], v[144:147], v[52:55]
	v_mfma_f32_16x16x32_bf16 v[48:51], v[156:159], v[144:147], v[48:51]
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_16x16x32_bf16 v[44:47], v[136:139], v[148:151], v[44:47]
	v_mfma_f32_16x16x32_bf16 v[40:43], v[140:143], v[148:151], v[40:43]
	v_mfma_f32_16x16x32_bf16 v[36:39], v[152:155], v[148:151], v[36:39]
	v_mfma_f32_16x16x32_bf16 v[32:35], v[156:159], v[148:151], v[32:35]

	; load A6-A7, reuse A4-A5 registers
	ds_read_b128 v[144:147], v131 offset:12288
	ds_read_b128 v[148:151], v131 offset:14336

	; wait A6, compute A6 x [B2, B3]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_16x16x32_bf16 v[20:23], v[152:155], v[144:147], v[20:23]
	v_mfma_f32_16x16x32_bf16 v[16:19], v[156:159], v[144:147], v[16:19]

	; wait A7, compute A7 x B2
	; prefetch B2 of inner k tile 1, reuse B2 reg
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_16x16x32_bf16 v[4:7], v[152:155], v[148:151], v[4:7]
	ds_read_b128 v[152:155], v134 offset:4096

	; compute A7 x B3
	; prefetch B3 of inner k tile 1, reuse B3 reg
	v_mfma_f32_16x16x32_bf16 v[0:3], v[156:159], v[148:151], v[0:3]
	ds_read_b128 v[156:159], v134 offset:6144

	; compute [A6, A7] x [B0, B1]
	v_mfma_f32_16x16x32_bf16 v[28:31], v[136:139], v[144:147], v[28:31]
	v_mfma_f32_16x16x32_bf16 v[24:27], v[140:143], v[144:147], v[24:27]
	v_mfma_f32_16x16x32_bf16 v[12:15], v[136:139], v[148:151], v[12:15]
	v_mfma_f32_16x16x32_bf16 v[8:11], v[140:143], v[148:151], v[8:11]

	; ##### inner k tile 1 #####
	; load B0-B1 and A0-A1
	; B2 and B3 were prefetched previously
	ds_read_b128 v[136:139], v134              ; load B0
	ds_read_b128 v[140:143], v134 offset:2048  ; load B1
	ds_read_b128 v[144:147], v133              ; load A0
	ds_read_b128 v[148:151], v133 offset:2048  ; load A1

	; wait B0-B1 + A0-A1, compute [A0, A1] x [B0, B1, B2, B3]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_16x16x32_bf16 v[112:115], v[136:139], v[144:147], v[112:115]
	v_mfma_f32_16x16x32_bf16 v[124:127], v[140:143], v[144:147], v[124:127]
	v_mfma_f32_16x16x32_bf16 v[120:123], v[152:155], v[144:147], v[120:123]
	...
	ds_read_b128 v[148:151], v133 offset:6144
	...
	; load A4-A5
	ds_read_b128 v[144:147], v133 offset:8192
	ds_read_b128 v[148:151], v133 offset:10240
	...
	; load A6-A7
	ds_read_b128 v[144:147], v133 offset:12288
	ds_read_b128 v[148:151], v133 offset:14336

	; wait A6-A7, compute [A6, A7] x [B0, B1, B2, B3]
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_16x16x32_bf16 v[28:31], v[136:139], v[144:147], v[28:31]
	v_mfma_f32_16x16x32_bf16 v[24:27], v[140:143], v[144:147], v[24:27]
	v_mfma_f32_16x16x32_bf16 v[20:23], v[152:155], v[144:147], v[20:23]
	...
	global_store_dwordx2 v[132:133], v[112:113], off offset:32
	v_cvt_pk_bf16_f32 v113, v122, v123
	v_cvt_pk_bf16_f32 v112, v120, v121
	global_store_dwordx2 v[132:133], v[112:113], off offset:64
	v_cvt_pk_bf16_f32 v113, v118, v119
	v_cvt_pk_bf16_f32 v112, v116, v117
	global_store_dwordx2 v[132:133], v[112:113], off offset:96
	v_or_b32_e32 v112, 16, v129
	global_store_dwordx2 v[132:133], v[114:115], off
	v_mul_lo_u32 v114, s1, v112
	v_mad_u64_u32 v[112:113], s[6:7], s0, v112, 0
	v_add3_u32 v113, v113, s4, v114
	v_lshl_add_u64 v[112:113], v[112:113], 1, s[2:3]
	v_lshl_add_u64 v[112:113], v[112:113], 0, v[130:131]
	v_cvt_pk_bf16_f32 v99, v98, v99
	v_cvt_pk_bf16_f32 v98, v96, v97
	v_or_b32_e32 v96, 32, v129
	global_store_dwordx2 v[112:113], v[98:99], off offset:96
	v_mul_lo_u32 v98, s1, v96
	v_mad_u64_u32 v[96:97], s[6:7], s0, v96, 0
	v_add3_u32 v97, v97, s4, v98
	v_lshl_add_u64 v[96:97], v[96:97], 1, s[2:3]
	...
	v_lshl_add_u64 v[96:97], v[96:97], 0, v[130:131]
	v_cvt_pk_bf16_f32 v83, v82, v83
	v_cvt_pk_bf16_f32 v82, v80, v81
	global_store_dwordx2 v[112:113], v[110:111], off
	global_store_dwordx2 v[112:113], v[106:107], off offset:32
	global_store_dwordx2 v[112:113], v[102:103], off offset:64
	global_store_dwordx2 v[96:97], v[82:83], off offset:96
	v_or_b32_e32 v82, s13, v128
	v_or_b32_e32 v80, 48, v82
	v_mul_lo_u32 v83, s1, v80
	v_mad_u64_u32 v[80:81], s[6:7], s0, v80, 0
	v_add3_u32 v81, v81, s4, v83
	v_lshl_add_u64 v[80:81], v[80:81], 1, s[2:3]
	...
	v_lshl_add_u64 v[80:81], v[80:81], 0, v[130:131]
	v_cvt_pk_bf16_f32 v67, v66, v67
	v_cvt_pk_bf16_f32 v66, v64, v65
	v_or_b32_e32 v64, 64, v129
	global_store_dwordx2 v[96:97], v[94:95], off
	global_store_dwordx2 v[96:97], v[90:91], off offset:32
	global_store_dwordx2 v[96:97], v[86:87], off offset:64
	global_store_dwordx2 v[80:81], v[66:67], off offset:96
	v_mul_lo_u32 v66, s1, v64
	v_mad_u64_u32 v[64:65], s[6:7], s0, v64, 0
	v_add3_u32 v65, v65, s4, v66
	v_lshl_add_u64 v[64:65], v[64:65], 1, s[2:3]
	...
	v_lshl_add_u64 v[64:65], v[64:65], 0, v[130:131]
	v_cvt_pk_bf16_f32 v51, v50, v51
	v_cvt_pk_bf16_f32 v50, v48, v49
	v_or_b32_e32 v48, 0x50, v129
	global_store_dwordx2 v[80:81], v[78:79], off
	global_store_dwordx2 v[80:81], v[74:75], off offset:32
	global_store_dwordx2 v[80:81], v[70:71], off offset:64
	global_store_dwordx2 v[64:65], v[50:51], off offset:96
	v_mul_lo_u32 v50, s1, v48
	v_mad_u64_u32 v[48:49], s[6:7], s0, v48, 0
	v_add3_u32 v49, v49, s4, v50
	...
	v_lshl_add_u64 v[48:49], v[48:49], 0, v[130:131]
	v_cvt_pk_bf16_f32 v35, v34, v35
	v_cvt_pk_bf16_f32 v34, v32, v33
	v_or_b32_e32 v32, 0x60, v129
	global_store_dwordx2 v[64:65], v[62:63], off
	global_store_dwordx2 v[64:65], v[58:59], off offset:32
	global_store_dwordx2 v[64:65], v[54:55], off offset:64
	global_store_dwordx2 v[48:49], v[34:35], off offset:96
	v_mul_lo_u32 v34, s1, v32
	v_mad_u64_u32 v[32:33], s[6:7], s0, v32, 0
	v_add3_u32 v33, v33, s4, v34
	...
	v_lshl_add_u64 v[32:33], v[32:33], 0, v[130:131]
	v_cvt_pk_bf16_f32 v19, v18, v19
	v_cvt_pk_bf16_f32 v18, v16, v17
	v_or_b32_e32 v16, 0x70, v82
	global_store_dwordx2 v[48:49], v[46:47], off
	global_store_dwordx2 v[48:49], v[42:43], off offset:32
	global_store_dwordx2 v[48:49], v[38:39], off offset:64
	global_store_dwordx2 v[32:33], v[18:19], off offset:96
	v_mul_lo_u32 v18, s1, v16
	v_mad_u64_u32 v[16:17], s[0:1], s0, v16, 0
	v_add3_u32 v17, v17, s4, v18
	...
	global_store_dwordx2 v[32:33], v[26:27], off offset:32
	global_store_dwordx2 v[32:33], v[22:23], off offset:64
	global_store_dwordx2 v[16:17], v[14:15], off
	global_store_dwordx2 v[16:17], v[10:11], off offset:32
	global_store_dwordx2 v[16:17], v[6:7], off offset:64
	global_store_dwordx2 v[16:17], v[2:3], off offset:96
	s_endpgm
.Lfunc_end0:
	.size	matmul_v2, .Lfunc_end0-matmul_v2
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel matmul_v2
	...
	.set .Lmatmul_v2.num_vgpr, 160
	.set .Lmatmul_v2.num_agpr, 0
	.set .Lmatmul_v2.numbered_sgpr, 27
	.set .Lmatmul_v2.num_named_barrier, 0
	.set .Lmatmul_v2.private_seg_size, 0
	.set .Lmatmul_v2.uses_vcc, 0
	.set .Lmatmul_v2.uses_flat_scratch, 0
	.set .Lmatmul_v2.has_dyn_sized_stack, 0
	.set .Lmatmul_v2.has_recursion, 0
	.set .Lmatmul_v2.has_indirect_call, 0
